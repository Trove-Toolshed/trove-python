...
class TroveArticle(TroveItem):
	...
	Newspaper articles
	'''
	api_url = 'http://api.trove.nla.gov.au/newspaper/{}?reclevel=full&encoding=json&key={}'
	item_type = 'article'
	title_field = 'heading'

	def get_pdf_url(self, zoom=3):
		return 'http://trove.nla.gov.au/ndp/del/printArticlePdf/{}/{}'.format(self.item_id, zoom)
